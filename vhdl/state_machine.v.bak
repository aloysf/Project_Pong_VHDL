module state_machine (
    input upper_lim_y, lower_lim_y, upper_lim_x, lower_lim_x,
    input BALL_SIZE,
    input initial_ball_x, initial_ball_y,
    input initial_dx, initial_dy,
    input paddle_size_x, paddle_size_y,
    input disp_shift,
    input paddle_1_x, paddle_2_x,
    input initial_paddle_dy, initial_paddle_y,

    input clk100Hz, reset, paddle_dy,
